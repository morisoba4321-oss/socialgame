...
async function fetchNaturalExampleUncached(word, opts = {}) {
  ...
  // 4) Semantic local template (meaning-aware, picked from a curated pool
  // per topic/POS). Used only when no human-written sentence was found.
  ...
  // 5) Generic AI-style offline template. Last resort so the game always
